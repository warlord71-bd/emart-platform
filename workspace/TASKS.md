...
|---|---|---|---|
| BLOG-1 | **Blog posts should include a generated featured image** relevant to the topic. Use `social_image_gen.py` or similar compositor to produce a branded blog hero image (topic text + product visual + Emart template). Image spec to be standardized later by owner. | [C] | 🔲 open |
...
| 4 | ✅ Critical UX trust contract | UX-ORCH-1 | ✅ Contract audit created: `workspace/docs/audits/storefront-trust-data-contract-20260625.md`; ✅ visible fallback counter relabeling/source flags implemented for category pulses, trending products, stock/sold bars, concern reviews, and PDP review copy. | No fake-live counters; no stock/price/Woo data writes. |
| 5 | ✅ Runtime/state map docs | ORCH-2, ORCH-4, ORCH-8 | ✅ Versioned process manifest + freshness/SLO spec created in `workspace/docs/process-manifest.md`; durable queue/state contract created in `workspace/docs/queue-state-contract.md`. | Docs/spec complete in `328572a`; implementation remains approval-first. |
| 6 | 🟡 Work ledger schema | SEO-ORCH-2, UX-ORCH-2 | ✅ Unified action/event ledger schema designed in `workspace/docs/action-ledger-schema.md`; ledger instantiation pending. | Schema complete in `328572a`; no ledger entries created yet. |
...
| 9 | 🟠 High measurement loop | SEO-ORCH-4, UX-ORCH-5, UX-ORCH-7, X8a, SEO-GAP-1, SEO-GAP-3 | Join GA4/GSC/GMC/Meta/RUM outcomes to change ledgers; add keep/iterate/revert review cadence. Fresh audit adds CTR/click-gap and usefulness-signal candidates. | Measurement/reporting first; no auto-optimization or mass rewrite without owner gate. |
| 10 | 🟡 Medium recovery/ops maturity | ORCH-6, ORCH-7, SEO-ORCH-3, SEO-ORCH-6, SEO-ORCH-7, UX-ORCH-9, SEO-GAP-4 | Add DR drill, CI/control-loop tests, technical SEO loop, URL-policy registry, off-page/entity ledger, and customer-feedback taxonomy. Fresh audit makes index/crawl drift the first SEO-ORCH-3 target. | Mostly post-critical; keep outreach/personal-data workflows approval-first. |
...
|---|---|---|---|---|---|---|
| 1 | SEO-GAP-4 | SEO-ORCH-3, SEO-ORCH-6 | 🔴 highest SEO technical | GSC Page Indexing UI shows 32,584 `Crawled - currently not indexed`, 5,641 redirects, 3,195 404s, 2,264 robots-blocked, 1,732 alternate canonical, 225 noindex, 106 soft 404, 57 5xx, 23 duplicate canonical, 5 forbidden; audit sample also found 100 GSC-not-sitemap URLs and 1 non-200 crawl sample. 2026-06-26 control-loop classifier wrote `workspace/audit/active/seo-technical-control-loop-20260626.md` and classified 201 sample rows: 1 P0 product 404, 98 P1 URL-policy/canonical-coverage rows, 1 P2 status-review row, 101 P3 expected/low-demand rows. Live verifier wrote `workspace/audit/active/seo-technical-control-loop-live-20260626.md` and checked 20 P0/P1 rows: 1 confirmed product 404, 6 query URLs redirecting to canonical, 12 category pagination query URLs returning 200/indexable, 1 page-89 404/noindex. URL-policy registry + validator now exist at `workspace/seo/url-policy-registry.json` and `workspace/scripts/seo_url_policy_registry.py`; validation assessed 38 query-policy rows with 19 matching target policy, 19 needing live verification, 0 unmatched, 0 drift. | Next: live-verify remaining concern/origin and unverified pagination query classes, then make only class-specific route/canonical/noindex changes if drift is proven. Smallest safe proposal now: no change for valid paginated collections, keep out-of-range pagination 404/noindex, and treat add-to-cart + brand query redirects as compliant. Confirm catalog/Woo replacement before touching the confirmed product 404. | 🟡 registry + proposal done; verification remains |
| 2 | SEO-GAP-1 | SEO-ORCH-4, SEO-ORCH-2, SEO-5 | 🟠 high commercial upside | Top 10 non-brand CTR/click-gap URLs show ~462 estimated missing clicks in the current 90-day GSC window. Top products include CeraVe night cream, SKIN1004 tone brightening ampoule, Medicube Vita C cream, COSRX snail essence, and Neutrogena body sunscreen. | Create ledger-backed title/meta/intent review candidates for the listed URLs, join GA4 engagement/conversion context, and route edits through existing title/content approval gates. No blanket title rewrites. | 🔲 open |
| 3 | SEO-GAP-3 | SEO-ORCH-2, SEO-ORCH-4, SEO-ORCH-5 | 🟠 high measurement/content quality | 10 crawled URLs have usefulness flags from rendered word count, GA4 engagement time, consumption-speed proxy, bounce, or internal-link signals. Examples include `/shop`, COSRX snail essence, SKIN1004 ampoule, `/best/cleanser-oily-skin-bangladesh`, `/brands`, and `/category/makeup-cosmetics`. | Feed usefulness flags into the durable SEO action ledger with GSC/GA4 evidence and promote only high-impact URLs to content review. Treat WPM/engagement as a triage signal, not proof of bad content by itself. | 🔲 open |
...
| 4 | UX trust contract | 4a UX-ORCH-1 | ✅ done | Trust claims are inventoried with source/fallback rules in `workspace/docs/audits/storefront-trust-data-contract-20260625.md`; fallback counters are visibly relabeled/source-flagged. |
...
| 7 | Visual safety | 7a UX-ORCH-3, 7b UX-ORCH-4, 7c UX-ORCH-8 | 🟡 audit/spec partial | Read-only visual safety audit created in `workspace/docs/audits/storefront-visual-safety-audit-20260625.md`; reusable screenshot/a11y harness and fixes remain pending. |
...
| 9 | Measurement loop | 9a SEO-ORCH-4, 9b UX-ORCH-5, 9c UX-ORCH-7, 9d X8a, SEO-GAP-1, SEO-GAP-3 | 🟡 partial | GA4/GSC/GMC/Meta/RUM outcomes attach to change ledgers with baseline, review windows, and keep/iterate/revert decisions. Social picker now consumes Meta/GSC/GMC/GA4 performance; fresh SEO gap audit produced CTR-gap and usefulness-signal candidates; SEO/UX ledgers and RUM remain separate open work. |
| 10 | Recovery / ops maturity | 10a ORCH-6, 10b ORCH-7, 10c SEO-ORCH-3, 10d SEO-ORCH-6, 10e SEO-ORCH-7, 10f UX-ORCH-9, SEO-GAP-4 | 🔲 open | Backups/restore drill, CI/control-loop tests, technical SEO loop, URL registry, off-page/entity ledger, and feedback taxonomy exist. Fresh GSC Page Indexing evidence makes SEO-GAP-4 the first technical SEO loop target. |
...
| 5a | ORCH-2 | ✅ docs complete | Versioned PM2/cron/detached/worker manifest created in `workspace/docs/process-manifest.md` (`328572a`). |
| 5b | ORCH-4 | ✅ spec complete | Freshness/SLO spec for last-success signals, duration, stale thresholds, retry/error classes, health checks, and recovery actions added to `workspace/docs/process-manifest.md` (`328572a`). |
| 5c | ORCH-8 | ✅ contract complete | Shared durable queue/state contract for locks, atomic writes, idempotency, retries, dead letters, recovery, and audit trails created in `workspace/docs/queue-state-contract.md` (`328572a`). |
| 6a | SEO-ORCH-2 | 🟡 schema designed | Unified durable action-ledger schema covers SEO recommendations; ledger instantiation pending (`workspace/docs/action-ledger-schema.md`, `328572a`). |
| 6b | UX-ORCH-2 | 🟡 schema designed | Unified event/action ledger schema covers UX recommendations/events; ledger instantiation pending (`workspace/docs/action-ledger-schema.md`, `328572a`). |
| 7a | UX-ORCH-3 | 🟡 matrix specified | Read-only route/viewport/state matrix defined in `workspace/docs/audits/storefront-visual-safety-audit-20260625.md`; screenshot capture harness pending. |
| 7b | UX-ORCH-4 | 🟡 drift measured | Static drift counts and priority targets documented in `workspace/docs/audits/storefront-visual-safety-audit-20260625.md`; governance/enforcement pending. |
| 7c | UX-ORCH-8 | 🟡 gate specified | Axe/keyboard/focus/contrast gate requirements documented in `workspace/docs/audits/storefront-visual-safety-audit-20260625.md`; automated runner pending. |
...
| 9a | SEO-ORCH-4 | 🔲 open | SEO changes join to GA4/GSC/order/GMC baselines and 7/28-day outcomes. First fresh-audit inputs are SEO-GAP-1 CTR/click-gap candidates (~462 estimated missing clicks) and SEO-GAP-3 usefulness-signal candidates. |
...
| 10c | SEO-ORCH-3 | 🟡 classifier + live sample + registry validation done | Read-only technical SEO control loop runs catalog/sitemap/Qdrant parity, samples, schema/canonical/404/redirect/query/news/internal-link/CWV checks. First target is SEO-GAP-4: `seo_technical_control_loop.py` classifies saved audit samples into P0/P1/P2/P3 action classes and can live-verify bounded P0/P1 rows; `seo_url_policy_registry.py` now validates query-policy rows against the versioned registry. Qdrant parity, CWV, scheduled monitoring, and broader rotating verification remain pending. |
| 10d | SEO-ORCH-6 | 🟡 initial registry + audit validator done | Initial versioned URL-policy registry exists at `workspace/seo/url-policy-registry.json` and is consumed by `workspace/scripts/seo_url_policy_registry.py`. Latest validation produced `workspace/audit/active/seo-url-policy-registry-validation-20260626.md`: 38 query-policy rows, 19 matching target policy, 19 requiring live verification, 0 unmatched, 0 drift. Middleware/metadata/robots/sitemap consumption remains future work. |
...
| X8a — Social Engine performance loop (audit F2): `record` subcommand exists, live `meta_schedule.js --record-history` can append published campaigns after a completed publish loop, product picking uses optional read-only performance JSON scores by product/slug/brand/category while still avoiding recent history, and `import-performance` now merges real Meta ledgers with latest local GSC, GMC health signals, and product-level GA4 landing-page metrics into `workspace/social-engine/performance/latest.json`. GA4 exporter wrote 870 product rows for the last 28 days and picker smoke passed. | ✅ complete |
...
| ORCH-4 | High | Replace presence-only monitoring with freshness/SLO monitoring: last successful run, duration, queue age, retry count, error class, commercial endpoint health, and alert recovery. Stop maintaining a hard-coded expected-stopped PM2 list. | ✅ spec complete 2026-06-25 in `328572a`: SLO table added to `workspace/docs/process-manifest.md`; implementation pending. |
...
| SEO-ORCH-2 | High | Replace daily overwritten `actions.json` with a durable SEO work ledger: stable action ID, canonical URL/entity, evidence snapshot, proposed change, owner, approval state, dependency, due/SLA, execution record, rollback pointer, verification state, and final outcome. Deduplicate recurring findings and escalate stale approvals such as the 21 pending title proposals. | 🟡 schema designed 2026-06-25 in `328572a`; ledger instantiation pending. |
| SEO-ORCH-3 | High | Schedule one read-only technical SEO control loop: catalog↔sitemap↔Qdrant parity and historical count deltas, representative plus rotating URL samples, metadata/schema/canonical/404/redirect-chain/query-policy/news-sitemap checks, internal-link/orphan crawl, GSC index/URL-inspection coverage, Core Web Vitals/CrUX, and last-success freshness alerts. | 🟡 classifier + live sample + registry validation done 2026-06-26: `workspace/scripts/active/seo_technical_control_loop.py` consumes the saved fresh audit and writes JSON/CSV/Markdown classification artifacts; `--verify-live` checked 20 bounded P0/P1 rows and found 12 category pagination query URLs returning 200/indexable, 6 query URLs already redirecting to canonicals, 1 product 404, and 1 out-of-range pagination 404/noindex. `workspace/scripts/seo_url_policy_registry.py` now validates 38 query-policy rows against `workspace/seo/url-policy-registry.json`. Remaining: broader rotating verification, Qdrant/catalog parity, CWV/CrUX, and scheduled freshness alerts. |
...
| SEO-ORCH-6 | Medium | Establish one versioned URL-policy registry consumed/tested by middleware, metadata, robots, sitemap, redirects and audit tools. Decide crawl/index/canonical behavior for every supported query parameter and detect drift; Googlebot currently bypasses generic robots query disallows while representative filter URLs return `index, follow` with a clean canonical. | 🟡 initial registry + audit validator done 2026-06-26: `workspace/seo/url-policy-registry.json` defines add-to-cart, brand, concern, origin, valid pagination, out-of-range pagination, and filter/tracking classes; `workspace/scripts/seo_url_policy_registry.py` validated 38 rows with 0 unmatched and 0 drift. Remaining: live-verify 19 unverified rows and wire registry checks into middleware/metadata/robots/sitemap tests. |
