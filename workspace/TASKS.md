...
| X4 — Social publishing: **2026-06-27** daily campaign scheduled live. Built 18 regular FB+IG posts with Creative Engine 2x assets at `/images/social/2026-06-27/daily-18-plus-6-reels/`; QA pass 0 errors; schedulers online as `emart-social-fb-20260627` + `emart-social-ig-20260627`. Because launch happened after early BDT slots, first 3 image slots skipped and item 4 published immediately (`FB 106908734057777_1328226289434333`, `IG 18129055909549166`). Six Facebook reels scheduled between regular posts via `emart-reels-20260627` plus catch-up `emart-reels-catchup-boj-20260627`; first original reel slot had expired, so BOJ catch-up is set for 19:35 BDT. Disposable `workspace/audit/active/social` images moved to `/root/.attic-2026-06-27/social-audit-active-images/`. | 🟢 running; monitor PM2/result ledger |
