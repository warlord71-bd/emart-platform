...
Summary: `3 modified, 4 untracked`
...
| 5 | ✅ Runtime/state map docs | ORCH-2, ORCH-4, ORCH-8 | ✅ Versioned process manifest + freshness/SLO spec created in `workspace/content-orchestrator/docs/specs/process-manifest.md`; durable queue/state contract created in `workspac… | Docs/spec complete in `328572a`; implementation remains approval-first. |
...
| ORCH-8 | High | Standardize durable automation queue/state handling across video, social, blog, humanizer, GSC/SEO, Qdrant and future workers: one lock per worker/domain, atomic state writes, idempotency k… | ✅ contract complete 2026-06-25 in `328572a`: `workspace/content-orchestrator/docs/specs/queue-state-contract.md`; runtime adoption pending. |
