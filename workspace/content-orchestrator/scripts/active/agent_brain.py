...
def build_brain() -> str:
    ...
    out.append("")
    out.append("This file is generated by `workspace/scripts/active/agent_brain.py`. It is a compact session-start brain, not a replacement for source files when editing.")
    out.append("")
    ...
    out.append("## Commands")
    out.append("")
    out.append("- Start: `python3 workspace/scripts/active/agent_start.py`")
    out.append("- Regenerate brain: `python3 workspace/scripts/active/agent_brain.py --write`")
    out.append("- Close helper: `python3 workspace/scripts/active/agent_close.py --help`")
    out.append("")
    return "\n".join(out) + "\n"
