...
- Before editing any of TASKS.md / SEO_MASTER.md / SESSION-LOG.md / .agent-memory/* / workspace/content-orchestrator/docs/*.py, quickly check both Local and VPS copies aren't already diverged from a prior session (`diff` the specific file across both trees) — don't assume one is current.
