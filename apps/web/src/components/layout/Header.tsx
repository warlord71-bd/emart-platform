        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            <button
              ...
              className="sm:hidden p-2 text-gray-600 hover:text-[#e8197a] transition-colors"
          ...
          <form onSubmit={handleSearch} className="mt-3 sm:hidden">
            <div className="relative flex items-center gap-2">
              <input
                ...
                autoFocus
                className="flex-1 border border-gray-200 rounded-full py-2.5 pl-4 pr-2
                           text-sm focus:outline-none focus:border-[#e8197a]
                           focus:ring-2 focus:ring-[#e8197a]/20 transition-all"
              />
              <button
                type="submit"
                className="bg-[#e8197a] text-white p-2.5 rounded-full
                           hover:bg-[#c01264] transition-colors flex-shrink-0"
              ...
              <button
                ...
                className="p-2 text-gray-600 hover:text-[#e8197a] transition-colors flex-shrink-0"
