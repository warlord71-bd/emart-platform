  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14">
      ...
      <div className="flex flex-col gap-4">
        ...
        {/* Brand · Origin · Volume — compact chips */}
        ...
        <div className="flex items-baseline gap-3">
          ...
          {discount > 0 && (
            <span className="badge-sale text-xs px-2 py-0.5 font-semibold">
              {discount}% OFF
            </span>
          )}
        </div>
        ...
        {product.sku && (
          <p className="text-xs text-gray-400">
            SKU: <span className="font-mono text-gray-500 bg-gray-50 border border-gray-200 px-1.5 py-0.5 rounded">
              {product.sku}
            </span>
          </p>
        )}
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center border border-gray-200 rounded-xl overflow-hidden">
              <button
                ...
                className="w-10 h-11 flex items-center justify-center text-lg font-medium
            ...
            <button
              ...
              className="flex-1 h-11 btn-primary flex items-center justify-center gap-2
            ...
            {/* Wishlist */}
            <button
              className="w-11 h-11 flex items-center justify-center border-2 border-gray-200
                         rounded-xl hover:border-[#e8197a] hover:text-[#e8197a] transition-colors"
            >
              <Heart size={18} />
            </button>
          </div>
        ...
        {/* ── Attribute tag cloud (Concern · Skin Type · others) ── */}
        {(() => {
            ...
            <div className="pt-1">
              ...
              <div className="flex flex-wrap gap-1.5">
                {tags.map(({ label, href, type }) => {
                  ...
                  const styles = {
                    concern: `${base} bg-purple-50 border border-purple-200 text-purple-700 hover:bg-purple-100`,
                    skin:    `${base} bg-blue-50 border border-blue-200 text-blue-700 hover:bg-blue-100`,
                    other:   `${base} bg-gray-100 text-gray-600`,
                  }[type];
                  return href
                    ? <Link key={label} href={href} className={styles}>{label}</Link>
                    : <span key={label} className={styles}>{label}</span>;
                })}
              </div>
            </div>
          );
      ...
      {/* ══════════════ FULL DESCRIPTION ══════════════ */}
      {product.description && (
        <div className="col-span-1 lg:col-span-2 border-t border-gray-100 pt-8 mt-2">
          <h2 className="text-lg font-bold text-[#1a1a2e] mb-4">Product Description</h2>
          <div
