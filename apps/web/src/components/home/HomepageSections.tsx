  ...
  return (
    <section className="bg-bg px-4 py-10">
      <div className="mx-auto max-w-6xl">
        ...
        {/* Social channels — colorful platform grid */}
        <div className="mt-8">
          <div className="mb-4 flex items-center justify-between">
            ...
            <Link href="/social" className="flex items-center gap-1 text-sm font-semibold text-accent hover:underline">
              <PlayCircle className="h-4 w-4" /> Watch all videos
            </Link>
          </div>
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            {/* YouTube */}
            <a href="https://www.youtube.com/@emartbd.official" target="_blank" rel="noopener noreferrer"
              className="group relative overflow-hidden rounded-2xl bg-[#FF0000] p-5 shadow-card transition-all hover:-translate-y-0.5 hover:shadow-pop">
              <div className="absolute -right-4 -top-4 h-20 w-20 rounded-full bg-white/10" />
              <svg viewBox="0 0 24 24" className="relative h-8 w-8 fill-white"><path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/></svg>
              <div className="mt-3 text-sm font-extrabold text-white">YouTube</div>
              <div className="mt-1 text-xs text-white/80">@emartbd.official</div>
              <div className="mt-3 text-[11px] font-bold text-white/70 group-hover:text-white">Watch tutorials →</div>
            </a>
            {/* TikTok */}
            <a href="https://www.tiktok.com/@emart_bdofficial" target="_blank" rel="noopener noreferrer"
              className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#010101] to-[#2d2d2d] p-5 shadow-card transition-all hover:-translate-y-0.5 hover:shadow-pop">
              <div className="absolute -right-4 -top-4 h-20 w-20 rounded-full bg-white/5" />
              <svg viewBox="0 0 24 24" className="relative h-8 w-8 fill-white"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.89a8.18 8.18 0 0 0 4.78 1.52V7a4.85 4.85 0 0 1-1.01-.31z"/></svg>
              <div className="mt-3 text-sm font-extrabold text-white">TikTok</div>
              <div className="mt-1 text-xs text-white/80">@emart_bdofficial</div>
              <div className="mt-3 text-[11px] font-bold text-white/50 group-hover:text-white">Watch unboxings →</div>
            </a>
            {/* Facebook */}
            <a href="https://www.facebook.com/emartbd.official" target="_blank" rel="noopener noreferrer"
              className="group relative overflow-hidden rounded-2xl bg-[#1877F2] p-5 shadow-card transition-all hover:-translate-y-0.5 hover:shadow-pop">
              <div className="absolute -right-4 -top-4 h-20 w-20 rounded-full bg-white/10" />
              <svg viewBox="0 0 24 24" className="relative h-8 w-8 fill-white"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              <div className="mt-3 text-sm font-extrabold text-white">Facebook</div>
              <div className="mt-1 text-xs text-white/80">emartbd.official</div>
              <div className="mt-3 text-[11px] font-bold text-white/70 group-hover:text-white">Watch videos →</div>
            </a>
            {/* Instagram */}
            <a href="https://www.instagram.com/emartbd.official/" target="_blank" rel="noopener noreferrer"
              className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#f09433] via-[#e6683c] to-[#dc2743] p-5 shadow-card transition-all hover:-translate-y-0.5 hover:shadow-pop">
              <div className="absolute -right-4 -top-4 h-20 w-20 rounded-full bg-white/10" />
              <svg viewBox="0 0 24 24" className="relative h-8 w-8 fill-white"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
              <div className="mt-3 text-sm font-extrabold text-white">Instagram</div>
              <div className="mt-1 text-xs text-white/80">@emartbd.official</div>
              <div className="mt-3 text-[11px] font-bold text-white/70 group-hover:text-white">View photos →</div>
            </a>
          </div>
        </div>
      </div>
