  ...
  return (
    <section className="bg-bg px-4 py-10">
      <div className="mx-auto max-w-6xl">
        ...
        <div aria-hidden="true" inert={true} className="-mx-4 overflow-x-auto px-4 pb-1 lg:hidden [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
  ...
  return (
    <section className="bg-bg px-4 py-10">
      <div className="mx-auto max-w-6xl">
        ...
        <div aria-hidden="true" inert={true} className="-mx-4 overflow-x-auto px-4 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden md:hidden">
