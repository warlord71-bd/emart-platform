...
export const OFFER_COLLECTIONS: OfferCollectionConfig[] = [
  ...
  },
  {
    slug: 'free-delivery',
    label: 'Free Delivery',
    eyebrow: 'Free delivery over ৳3,000',
    title: 'Free Delivery Products',
    description: 'Shop authentic skincare products and combo offers priced ৳3,000+ at Emart Skincare Bangladesh, curated to help build a free delivery cart.',
