...
export const OFFER_COLLECTIONS: OfferCollectionConfig[] = [
  ...
  },
  {
    slug: 'free-delivery',
    label: 'Free Delivery',
    eyebrow: 'Free delivery picks',
    title: '7 Free Delivery Picks',
    description: 'Shop selected skincare products and combo offers that help build ৳3,000+ baskets for free delivery at Emart Skincare Bangladesh.',
    href: '/offers/free-delivery',
    hint: 'Selected ৳3,000+ cart builders',
    icon: 'truck',
