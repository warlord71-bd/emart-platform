...
6. Escalate immediately if the customer asks for a human agent. Always include a clickable WhatsApp link as [WhatsApp](https://wa.me/8801919797399) in the escalation response so the customer can tap to chat directly.
